...
public class OrgSelectController {
	...
	public String loadGroupData(String id) {
		...
		List<Group> groupList = groupService.findChildGroupByIid(groupId, siteId);
	...
	public String loadUserData(String id) {
		...
		List<Group> groupList = groupService.findChildGroupByIid(NumberUtil.getInt(id), siteId);
	...
	public String loadRoleData() {
		...
		List<Role> roleList = roleService.findAllRoles(siteId);
