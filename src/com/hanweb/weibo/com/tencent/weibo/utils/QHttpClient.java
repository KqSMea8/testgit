package com.hanweb.weibo.com.tencent.weibo.utils;
...
import com.hanweb.weibo.com.tencent.weibo.beans.RouteCfg;
...
//        if (queryString != null && !queryString.equals("") && queryString.indexOf("?") == -1) {
//            url += "?" + queryString;
//        }
...
//            System.out.println("===ret==="+responseData);
...
//            httpGet.abort();
//        }
    	String ret = HttpClientUtil.getInfoTrustAll(url + "?" + queryString, "UTF-8");
...
//    httpGet.getParams().setParameter("http.socket.timeout", Integer.valueOf(5000));
//
