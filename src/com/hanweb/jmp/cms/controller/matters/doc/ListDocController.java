...
public class ListDocController implements GridViewDelegate{
	...
	public GridView list(HttpServletRequest request, GridView gridView, Integer classId,String name) {
		...
		gridView.setViewName("jmp/cms/matters/doc/doc_list");
	...
	private void createBody(GridView gridView, Integer classId, String searchName) {
		...
		gridViewSql.addSelectField("iid").addSelectField("name").addSelectField("createtime").setTable(Tables.DOC);
