...
public class ListVideoController implements GridViewDelegate{
	...
	public GridView list(HttpServletRequest request, GridView gridView, Integer classId,String name) {
		...
		gridView.setViewName("jmp/cms/matters/video/video_list");
	...
	private void createBody(GridView gridView, Integer classId, String searchName) {
		...
		gridViewSql.addSelectField("iid").addSelectField("name").addSelectField("createtime").addSelectField("videopath").setTable(Tables.VIDEO);
