...
public class RoleDAO extends BaseJdbcDAO<Integer, Role> {
	 ...
	 * @return
	 */
	public List<Role> findAllRoles(int siteId) {
		String sql = " SELECT iid, name, type , siteid FROM " + Tables.ROLE +
					 " WHERE siteid=:siteid AND type=6 ORDER BY iid ";
		Query query = createQuery(sql);
	...
	public List<Role> findRolesByUserIdOrGroupId(Integer userId, Integer groupId) {
		...
		String sql = "SELECT DISTINCT b.iid, b.name, b.type, b.siteid " + "FROM " + Tables.ROLERELATION
