		...
		<div id="orgselect-source" data-options="tabPosition:'left',headerWidth:100" class="easyui-tabs" style="width: 500px; height: 405px;">
			<div id="groupselect" title="栏目">
				...
				<div id="grouptreewrap" style="height: 358px; overflow: auto; position: relative;">
					<ul id="grouptree" class="easyui-tree selectsource batchselect" data-options="onCollapse:fitGroupTreeWrap,onExpand:fitGroupTreeWrap,onDblClick:toggleNode,onLoadSuccess:loadNodeSuccess" url="infos_load.do?pid=${pid }">
					</ul>
