...
public class ListDocColController implements GridViewDelegate{
	...
	public GridView list(HttpServletRequest request, GridView gridView, String name) {
		...
		gridView.setViewName("jmp/cms/matters/doc/doccol_list");
	...
	private void createBody(GridView gridView, String searchName) {
		...
		gridViewSql.addSelectField("iid").addSelectField("name").addSelectField("createtime").setTable(Tables.DOCCOL);
