...
<body>
	<form action="${url }" method="post" id="oprform">
		<input type="hidden" id="iid" name="iid" value="${brokeType.iid}">
		<input type="hidden" id="siteId" name="siteId" value="${brokeType.siteId }">
		<input type="hidden" id="orderId" name="orderId" value="${brokeType.orderId }">
		<input type="hidden" id="pid" name="pid" value="${brokeType.pid}">
			...
			<table border="0" align="center" cellpadding="10" cellspacing="0" class="table">
				<tr>
					...
					<td><input type="text" id="name" name="name" maxlength="33"
						       class="input-text" value="${brokeType.name }" /></td>
				</tr>
				
				<tr>
					<td align="right" class="label">审核方式</td>
					<td class="required">*</td>
					<td><input type="radio" id="auditType" name="auditType" value="0" data-value="${brokeType.auditType }" />手动审核
						<input type="radio" id="auditType" name="auditType" value="1" data-value="${brokeType.auditType }" />自动审核 
					</td>
				</tr>
				...
				<tr>
					...
					<td>&nbsp;</td>
					<td><textarea id="spec" name="spec" class="input-textarea">${brokeType.spec }</textarea>
					</td>
				</tr>
			</table>
		</div>
