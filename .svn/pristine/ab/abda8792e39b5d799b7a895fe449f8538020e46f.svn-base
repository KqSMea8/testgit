...
<body>
	<form action="${url }" method="post" id="oprform">
		<input type="hidden" id="iid" name="iid" value="${videoCol.iid}">
		<input type="hidden" id="siteId" name="siteId" value="${videoCol.siteId }">
		<input type="hidden" id="orderId" name="orderId" value="${videoCol.orderId }">
		<input type="hidden" id="pid" name="pid" value="${videoCol.pid}">
			...
			<table border="0" align="center" cellpadding="10" cellspacing="0"
				...
				<tr>
					...
					<td><input type="text" id="name" name="name" maxlength="33"
						class="input-text" value="${videoCol.name }" /></td>
				</tr>
				<tr>
					<td align="right" class="label">分类描述</td>
					<td>&nbsp;</td>
					<td><textarea id="spec" name="spec" class="input-textarea">${videoCol.spec }</textarea>
					</td>
				</tr>
			</table>
		</div>
