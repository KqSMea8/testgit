...
public class GroupMenuController {
	...
	public ModelAndView showGroupMenu() {
		...
		List<Group> groupList = groupService.findChildGroupByIid(rangeId, NumberUtil.getInt(siteId));
	...
	public String searchAsyncMenuWithUrl(int groupId, String isDisabled) {
		...
		List<Group> groupList = groupService.findChildGroupByIid(groupId, NumberUtil.getInt(siteId));
