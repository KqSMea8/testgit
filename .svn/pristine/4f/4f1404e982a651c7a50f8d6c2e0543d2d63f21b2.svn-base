package com.hanweb.weibo.weibo4j;

import java.util.List;
import java.util.Map;

import com.hanweb.weibo.weibo4j.http.ImageItem;
import com.hanweb.weibo.weibo4j.model.Emotion;
import com.hanweb.weibo.weibo4j.model.FriendsTimelineIds;
import com.hanweb.weibo.weibo4j.model.MentionsIds;
import com.hanweb.weibo.weibo4j.model.Paging;
import com.hanweb.weibo.weibo4j.model.PostParameter;
import com.hanweb.weibo.weibo4j.model.RepostTimelineIds;
import com.hanweb.weibo.weibo4j.model.Status;
import com.hanweb.weibo.weibo4j.model.StatusWapper;
import com.hanweb.weibo.weibo4j.model.UserTimelineIds;
import com.hanweb.weibo.weibo4j.model.WeiboException;
import com.hanweb.weibo.weibo4j.org.json.JSONArray;
import com.hanweb.weibo.weibo4j.org.json.JSONObject;
import com.hanweb.weibo.weibo4j.util.ArrayUtils;
...
public class Timeline extends Weibo {
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getTimelineBatch(Map<String, String> map)
			throws WeiboException {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return client.get(WeiboConfig.getValue("baseURL") + "statuses/timeline_batch.json", parList,
				access_token).asJSONObject();
	}
