...
<body>
    <div class="gongneng_center">
    	<div class="top" >
     		<div class="top_main">
	     	    <div class="top_left">
	            	<p style="margin:30px 5px ; font-size:25px ;font-family:微软雅黑; color:#000000" align="left">APP自动创建工场</p>
	            </div>
		        ...
		        <div class="toul">
		            ...
		            <div class="jiben_zuobian">
		                <div class="yingyong_name">
		                    <span>应用名称</span>
		                    <input  id="apptitle" style="padding-left:10px;" class="biaoti" value="${app.name}" maxlength="10" onChange="changeTitleValue()" disabled="disabled"/>
		                ...
		                <div style="margin-top:30px;height:40px">
		                     ...
		                     <div style="float:left;height:40px;padding-left:40px;margin-top:4px">
		                     ...
		                     <div style="clear:both;padding-left:65px;color: #838e9e;">
		                ...
		                <div class="peizhi_qidongtu">
		                    <span>启动图</span>
		                    <div class="peizhi_gde" style="width:119px;padding-left:12px">
    ...
    <script type="text/javascript">
        ...
        function nextstep(){
            ...
            var logoIcon=$('#logoIcon').val(); 
             ...
             }else if(spec!=""&& (spec.indexOf('#')>=0 || spec.indexOf('&')>=0)){
