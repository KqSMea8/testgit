...
<script type="text/javascript">
	function toolbarAction(action) {
		...
		case 'remove':
			...
			break;
		case 'add':
			openDialog('matter/add_show.do', 550, 320, {
				title : '分类新增'
			});
			break;
		case 'sort':
			openDialog('matter/sort_show.do', 550, 510, {
				title : '分类排序 '
			});
			break;
		}
	...
	function edit(iid, name) {
		openDialog('matter/modify_show.do?iid=' + iid, 550, 320, {
			title : '分类编辑' 
		});
	}
</script>
...
<body>
	<div id="page-title"> 
		素材管理 / <span id="page-location">图片分类</span>   
	</div>
	<div id="page-content">
