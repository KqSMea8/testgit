...
<body>
	<form action="${url }" method="post" id="oprform">
		<input type="hidden" id="iid" name="iid" value="${pictureCol.iid}">
		<input type="hidden" id="siteId" name="siteId" value="${pictureCol.siteId }">
		<input type="hidden" id="orderId" name="orderId" value="${pictureCol.orderId }">
		<input type="hidden" id="pid" name="pid" value="${pictureCol.pid}">
			...
			<table border="0" align="center" cellpadding="10" cellspacing="0"
				...
				<tr>
					...
					<td><input type="text" id="name" name="name" maxlength="33"
						class="input-text" value="${pictureCol.name }" /></td>
				</tr>
				<tr>
					<td align="right" class="label">分类描述</td>
					<td>&nbsp;</td>
					<td><textarea id="spec" name="spec" class="input-textarea">${pictureCol.spec }</textarea>
					</td>
				</tr>
			</table>
		</div>
