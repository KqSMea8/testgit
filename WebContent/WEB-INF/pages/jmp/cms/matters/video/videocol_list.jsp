...
<script type="text/javascript">
	function toolbarAction(action) {
		...
		case 'remove':
			...
			break;
		case 'add':
			openDialog('matter/videocol/add_show.do', 550, 320, {
				title : '分类新增'
			});
			break;
		case 'sort':
			openDialog('matter/videocol/sort_show.do', 550, 510, {
				title : '分类排序 '
			});
			break;
		}
	...
	function edit(iid, name) {
		openDialog('matter/videocol/modify_show.do?iid=' + iid, 550, 320, {
			title : '分类编辑' 
		});
	}
</script>
...
<body>
	<div id="page-title"> 
		素材管理 / <span id="page-location">音视频分类</span>   
	</div>
	<div id="page-content">
