...
function toolbarAction(action) {
	...
	case 'recycle':
		...
		page="${contextPath}/manager/matter/video/recycle/list.do?classId=${classId}&name=${name}";
		location.href=page;
		break;
	...
	case 'remove':
		...
		openDialog("matter/video/remove_show.do?ids=" + ids+"&idlength="+ids.split(",").length, 420, 270, {
			title : '删除音视频'
		});
		break; 
	}
...
// 编辑
function edit(iid) {
	openDialog('matter/video/modify_show.do?iid=' + iid, 550, 250, {
		title : '音视频编辑'  
	});
}
...
<body>
	<div id="page-title">
	          音视频分类 /  <span id="page-location">${name }</span>
	</div>
