...
<body >  
	<form action="${url}"  method="post" id="oprform" name="oprform"> 
		...
		<input type="hidden" name="titleId" id="titleId" value="${infoCount.titleId}" /> 
		<input type="hidden" name="type" id="type" value="${infoCount.type}" /> 
		<div id="dialog-content">
			<table border="0" align="center" cellpadding="10" cellspacing="0"
				class="table">
					<tr>
					<td align="right" class="label">阅读数数</td>
					<td class="required">*</td>
					<td><input type="text" id="visitCount" name="visitCount" value="${infoCount.visitCount}" class="input-text" maxlength="33"></td>
				</tr>
			</table>
		</div> 
