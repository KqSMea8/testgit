...
<title>信息删除</title>
<h:head pagetype="dialog" multiselect="true" menu="true" tree="true" validity="true" 
        checkpwd="true" tabs="true" tip="true" select="true" upload="true"></h:head>
<script>
	$(function() { 
	...
	<form action="${url}" method="post" id="oprform" name="oprform" enctype="multipart/form-data">
		...
		<div id="dialog-content">
			<table border="0" align="center" cellpadding="10" cellspacing="15"
				class="table"> 
				<tr> 
					<td>您确认删除这${idlength}条信息吗？</td>
					 
				</tr> 
				<tr>  
					<td>
						<input type="checkbox" id="showList" name="showList"
								 value="1" data-value="1" />放入回收站 （若不选中该项，则信息将被彻底清除）
					</td>
				</tr> 
			</table>
		</div>
