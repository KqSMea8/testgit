...
<script>
	...
	function backAdminLogin(name, password){
		var cookiePath = '${contextPath}/';
		$.cookie('channel', null, {path: cookiePath});
		$.cookie('pageUrl', null, {path: cookiePath});
		$.cookie('menuUrl', null, {path: cookiePath}); 
		ajaxSubmit("backAdminLogin.do?name=" + name + "&password=" + password, {success:function(result){
			if(result.success){
...
<body>
	<div id="header">
		...
		<div id="header-container">
			<div id="logo" title="${siteName }" style="">  
				<label class="label" style="font-size: 26px; font-weight: 500;text-overflow:ellipsis; 
					white-space:nowrap">${siteName }</label>    
